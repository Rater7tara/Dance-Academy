...
const Footer = () => {
    return (
        <>
            ...
            <div>
                    <span className="footer-title text-2xl">Contacts</span>
                    <p>Gazipur Chowrasta</p>
                    <p>Dhaka, Bangladesh</p>
                    <p>dancetildawn@gmail.com</p>
                    <p>0171-14-488-99</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <a className="link link-hover">Events Calender</a>
  ...
  <div className="grid grid-flow-col gap-4">
    <h1 className='text-3xl'>Dance 'til Dawn</h1>
  </div> 
  <div>
    <div className="grid grid-flow-col gap-4">
  ...
  <div>
    <p>Copyright © 2023 - All right reserved by Dance 'til Dawn</p>
  </div>
</footer>
        </>
    );
